  ...
  return (
    ...
    >
      <View style={{
        ...
        <PostDisplay posterUserName = {'posterUserName'} posterUserImage={'DP'} posterUserStreak={3} imagePostedByUser={'https://onlinejpgtools.com/images/examples-onlinejpgtools/girl-with-camera.jpg'}
        setReactionModalOpen={setReactionModalOpen}/>
